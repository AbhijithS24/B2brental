 ...
 */
package com.training.initialdata.setup;
...
public class InitialDataSystemSetup extends AbstractSystemSetup {
    ...
    private static ImportData createDellImportData(String storeId) {
        final var powertoolsImportData = new ImportData();
        powertoolsImportData.setProductCatalogName(storeId);
        powertoolsImportData.setContentCatalogNames(Collections.singletonList(storeId));
        powertoolsImportData.setStoreNames(Collections.singletonList(storeId));
        return powertoolsImportData;
    }
    ...
    public void createProjectData(final SystemSetupContext context) {
        ...
        importData.add(createDellImportData(POWERTOOLS));

        coreDataImportService.execute(this, context, importData);
        getEventService().publishEvent(new CoreDataImportedEvent(context, importData));
